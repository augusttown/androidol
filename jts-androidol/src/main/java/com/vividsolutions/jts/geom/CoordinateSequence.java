...
public interface CoordinateSequence extends Cloneable {
	...
	/**
	 * Returns a copy of the i'th coordinate in this sequence. This method
	 * optimizes the situation where the caller is going to make a copy anyway -
	 * if the implementation has already created a new Coordinate object, no
