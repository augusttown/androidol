...
package com.androidol.proj4j.map;

//import java.awt.geom.*;
import com.androidol.proj4j.map.proj.*;
...
public class MapMath {
	...
	public final static GeometryFactory jtsGeometryFactory = new GeometryFactory();
...
*/
	...
	public static int intersectSegments(Point aStart, Point aEnd, Point bStart, Point bEnd, Point p) {
		...
		double pX, pY;
		num = b1*c2 - b2*c1;
		pX = (num < 0 ? num-offset : num+offset) / denom;
		num = a2*c1 - a1*c2;
		pY = (num < 0 ? num-offset : num+offset) / denom;
		p = jtsGeometryFactory.createPoint(new Coordinate(pX, pY));
		return DO_INTERSECT;
	}
	...
	public static Point perpendicular(Point a) {		
		return jtsGeometryFactory.createPoint(new Coordinate(-a.getY(), a.getX()));
	}
	
	public static Point add(Point a, Point b) {		
		return jtsGeometryFactory.createPoint(new Coordinate(a.getX()+b.getX(), a.getY()+b.getY()));
	}
	...
	/*
	public static void normalize(Point a) {
	...
	*/
	...
	/*
	public static void negate(Point a) {
		a.x = -a.x;
		a.y = -a.y;
	}
	*/
